...
<body>
	...
	<div class="container">	
		...
		<div class="row">
	        ...
	        <div class="col-md-4">
	          <h2><spring:message code="INDICE_OEE_EM_TEMPO_REAL" /></h2>
	          <p><spring:message code="DESCRICAO_INDICE_OEE_TEMPO_REAL" /></p>
	          <p><a class="btn btn-default" href="real" role="button"><spring:message code="VER_DETALHES" /> &raquo;</a></p>
	        </div>
