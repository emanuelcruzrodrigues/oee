...
<body>
	...
	<div class="container">	
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				<c:forEach items="${list}" var="operacao">
					<tr class="gradeA">
						<td class="numeric">${operacao.codigo}</td>
						<td>${operacao.nome}</td>
						<td><spring:message code="${operacao.dmSituacao.meaningKey}" text="${operacao.dmSituacao}" /></td>
						<td>
							<button class="btn btn-default" onclick="actionEditar(${operacao.id});"><spring:message code="EDITAR" text="EDITAR" /></button>
							<button class="btn btn-danger" onclick="actionExcluir(${operacao.id});"><spring:message code="EXCLUIR" text="EXCLUIR" /></button>
						</td>
					</tr>
				</c:forEach>
			</tbody>
