...
<body>
	...
	<div class="container">	
		...
		<form:form action="salvar" modelAttribute="bean" method="POST" class="form-horizontal">
			...
			<div class=<%=JSPUtils.printFormGroupFeedback(request, "dtHrInicio")%>>
				<div class="col-md-4">
					<label class="control-label" for="dtHrInicio"><spring:message code="DATA_HORA_ENTRADA" /></label>
					<form:input type="text" path="dtHrInicio" id="dtHrInicio" class="form-control" />
				</div>					
			</div>
			
			<div class=<%=JSPUtils.printFormGroupFeedback(request, "dtHrFim")%>>
				<div class="col-md-4">
					<label class="control-label" for="dtHrFim"><spring:message code="DATA_HORA_ENCERRAMENTO" /></label>
					<form:input type="text" path="dtHrFim" id="dtHrFim" class="form-control"/>
				</div>					
			</div>
